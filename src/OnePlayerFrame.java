...
public class OnePlayerFrame extends JFrame {
	...
	OnePlayerFrame() {
		...
		final JLabel panel = new JLabel(
				new ImageIcon("C:\\Users\\IMOE001\\Desktop\\java-pong-game-main\\src\\Images\\mainbg.png"));
		...
		Icon icon = new ImageIcon("C:\\Users\\IMOE001\\Desktop\\java-pong-game-main\\src\\Images\\mouse.png");
		JButton mouse = new JButton(icon);
		mouse.setBounds(10, 100, 70, 85);
		panel.add(mouse);

		Icon icon2 = new ImageIcon("C:\\Users\\IMOE001\\Desktop\\java-pong-game-main\\src\\Images\\keyboard.png");
		JButton keyboard = new JButton(icon2);
		keyboard.setBounds(10, 200, 95, 85);
		panel.add(keyboard);

		Icon icon3 = new ImageIcon("C:\\Users\\IMOE001\\Desktop\\java-pong-game-main\\src\\Images\\back.png");
